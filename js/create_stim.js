function create_stim(sc,callback)
{
	if (sc.trial == 1){
		...
		var area1 = AreaSum + stream1.normal(0,1) * 1000;   if (area1 < 500){area1 ==1000}

		var area2 = area1 - area1 * trial_stimval;																	// stimuli areas
		...
		DataToSave.circleorsquare = sc.circleorsquare[sc.trial-1] 									// the third stimulus, a circle or a square
    ...
    if (sc.circleorsquare[sc.trial-1] ==1){  																		// plots the distractor, always in context3 (may be a circle or a square)
